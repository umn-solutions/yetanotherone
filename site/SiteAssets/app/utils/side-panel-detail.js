...
export async function openInitiativeDetail(initiative, context, onSuccess, { canAct = true } = {}) {
  ...
  const EVENT_TO_STATUS = {
    ...
    [EVENT_TYPES.SAVINGS_SUBMISSION]:      STATUS.EM_VALIDACAO_MENTOR,
    [EVENT_TYPES.MENTOR_FINAL_VALIDATION]: STATUS.EM_VALIDACAO_GESTOR,
    [EVENT_TYPES.BUSINESS_VALIDATION]:     STATUS.EM_VALIDACAO_MM,
